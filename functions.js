...
async function reset(client, message) {
  ...
  let resetemb = new MessageEmbed()
    ...
    .setDescription(
      "[Invite](https://discord.com/api/oauth2/authorize?client_id=950059540290879538&permissions=8&scope=bot%20applications.commands) | [Commands](https://moosic.live/commands) | [Support](https://discord.gg/zvndqvAvKf)"
    )
